...
class MovimentoMensalQueryFactory extends QueryFactory
{
    ...
    protected $query = <<<'SQL'
        select
            ...
            sum(case when masculino and transferido and enturmacao_transferida and saiu_durante then 1 else 0 end) as mat_transf_m,
            sum(case when feminino and transferido and enturmacao_transferida and saiu_durante then 1 else 0 end) as mat_transf_f,
            ...
            sum(case when masculino and falecido and enturmacao_falecido and saiu_durante then 1 else 0 end) as mat_falecido_m,
            sum(case when feminino and falecido and enturmacao_falecido and saiu_durante then 1 else 0 end) as mat_falecido_f,
