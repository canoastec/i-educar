...
return new class extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        $this->breadcrumb(currentPage: 'Registro de aluno em FICAI', breadcrumbs: [
    ...
    public function Gerar()
    {
        ...
        $this->inputsHelper()->date(attrName: 'data_cancel', inputOptions: ['label' => 'Data FICAI', 'placeholder' => 'dd/mm/yyyy', 'value' => date(format: 'd/m/Y')]);
        // text
    ...
    public function Novo()
    {
        ...
        $obj_matricula = new clsPmieducarMatricula(
            ...
            ref_cod_aluno: null,
            aprovado: App_Model_MatriculaSituacao::FICAI
        );
        ...
        if (is_null(value: $det_matricula['data_matricula'])) {
            if (substr(string: $det_matricula['data_cadastro'], offset: 0, length: 10) > $obj_matricula->data_cancel) {
                $this->mensagem = 'Data FICAI não pode ser inferior a data da matrícula.<br>';
        ...
        if ($obj_matricula->edita()) {
            if ($obj_matricula->cadastraObsFicai(obs: $this->observacao, tipoAbandono: $this->abandono_tipo, deixouDeFrequentarIdadeObrigatoria: $this->deixou_de_frequentar_idade_obrigatoria)) {
                ...
                if (!is_null(value: $notaAluno)) {
                    (new Avaliacao_Model_NotaComponenteMediaDataMapper)
                        ->updateSituation(notaAlunoId: $notaAluno->get('id'), situacao: App_Model_MatriculaSituacao::FICAI);
                }
                ...
                $this->mensagem = 'Situação FICAI cadastrada com sucesso.<br>';
        ...
        $this->mensagem = 'FICAI não pode ser realizado.<br>';
